...
class EditScheduleActivity : AppCompatActivity() {
    ...
    private fun showSearchPopup() {
        ...
        btnSearchHospital.setOnClickListener {
            ...
            if (query.isNotEmpty()) {
                searchHospitals(query, citySpinner, districtSpinner, dialog)
            } else {
    ...
    private fun loadCitySpinner(citySpinner: Spinner, districtSpinner: Spinner) {
        ...
        cityRef.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val cityAdapter = ArrayAdapter(this@EditScheduleActivity, android.R.layout.simple_spinner_dropdown_item, cityNames)
        ...
        hospitalRef.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                for (child in snapshot.children) {
                    ...
                    val address = child.child("address").getValue(String::class.java) ?: "주소 없음"
                ...
                if (hospitalList.isNotEmpty()) {
                    ...
                    Toast.makeText(this@EditScheduleActivity, "검색 결과가 없습니다", Toast.LENGTH_SHORT).show()
                }
            }
